...
describe('convertRestQueryParams', () => {
  ...
  test('Runs correctly on valid input', () => {
    ...
    expect(convertRestQueryParams()).toEqual({});
    expect(convertRestQueryParams({})).toEqual({});
  ...
  describe('Sort param', () => {
    ...
    test.each([
      ...
      expect(convertRestQueryParams({ _sort: input })).toEqual({ sort: expected });
    });
  });
  ...
  describe('Start param', () => {
    ...
    test.each([['1', 1], ['12', 12], ['0', 0]])(
      ...
      (input, expected) => {
        expect(convertRestQueryParams({ _start: input })).toEqual({ start: expected });
      }
    );
  });
  ...
  describe('Filters', () => {
    test('Can combine filters', () => {
      expect(convertRestQueryParams({ id: '1', test_ne: 'text', test_: 'content' })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'eq',
    ...
    test('Ok', () => {
      expect(convertRestQueryParams({ id: '1', test: 'text' })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'eq',
      ...
      expect(convertRestQueryParams({ id_eq: '1', test_eq: 'text' })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'eq',
      ...
      expect(convertRestQueryParams({ published_at: '2019-01-01:00:00:00' })).toEqual({
        where: [
          {
            field: 'published_at',
            operator: 'eq',
    ...
    test('Not Eq', () => {
      expect(convertRestQueryParams({ id_ne: 1 })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'ne',
    ...
    test('Less than', () => {
      expect(convertRestQueryParams({ id_lt: 1 })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'lt',
    ...
    test('Less than or equal', () => {
      expect(convertRestQueryParams({ id_lte: 1 })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'lte',
    ...
    test('Greater than', () => {
      expect(convertRestQueryParams({ id_gt: 1 })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'gt',
    ...
    test('Greater than or equal', () => {
      expect(convertRestQueryParams({ id_gte: 1 })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'gte',
    ...
    test('In', () => {
      expect(convertRestQueryParams({ id_in: [1, 2] })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'in',
    ...
    test('Not in', () => {
      expect(convertRestQueryParams({ id_nin: [1, 3] })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'nin',
    ...
    test('Contains', () => {
      expect(convertRestQueryParams({ id_contains: 'text' })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'contains',
    ...
    test('Contains sensitive', () => {
      expect(convertRestQueryParams({ id_containss: 'test' })).toEqual({
        where: [
          {
            field: 'id',
            operator: 'containss',
    ...
    test('Not Contains', () => {
      expect(convertRestQueryParams({ sub_title_ncontains: 'text' })).toEqual({
        where: [
          {
            field: 'sub_title',
            operator: 'ncontains',
    ...
    test('Not Contains sensitive', () => {
      expect(convertRestQueryParams({ content_text_ncontainss: 'test' })).toEqual({
        where: [
          {
            field: 'content_text',
            operator: 'ncontainss',
    ...
    test('Not Contains sensitive', () => {
      expect(convertRestQueryParams({ 'content.text_ncontainss': 'test' })).toEqual({
        where: [
          {
            field: 'content.text',
            operator: 'ncontainss',
